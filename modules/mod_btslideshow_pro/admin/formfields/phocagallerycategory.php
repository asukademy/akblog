...
class JFormFieldPhocaGalleryCategory extends JFormField {
    ...
    protected function getInput() {
        ...
        if ($helper->checkPhocaComponent()) {
            ...
            array_unshift($tree, JHTML::_('select.option', '', '- ' . JText::_('MOD_BTSLIDESHOW_PHOCA_ALL_CATEGORIES') . ' -', 'value', 'text'));
            ...
            $class = $this->element['class'] ? (string) $this->element['class'] : '';
            return "<div class='{$class}'>".JText::_('MOD_BTSLIDESHOW_PHOCA_ALERT')."</div>";
        }
    }
